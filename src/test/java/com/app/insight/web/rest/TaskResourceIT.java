...
import com.app.insight.repository.TaskRepository;
import com.app.insight.service.dto.TaskDTO;
import com.app.insight.service.mapper.TaskMapper;
...
class TaskResourceIT {
    ...
    public static Task createEntity(EntityManager em) {
        Task task = new Task().description(DEFAULT_DESCRIPTION).deadline(DEFAULT_DEADLINE);
        return task;
    }
    ...
    public static Task createUpdatedEntity(EntityManager em) {
        Task task = new Task().description(UPDATED_DESCRIPTION).deadline(UPDATED_DEADLINE);
        return task;
    }
    ...
    void putExistingTask() throws Exception {
        ...
        updatedTask.description(UPDATED_DESCRIPTION).deadline(UPDATED_DEADLINE);
    ...
    void partialUpdateTaskWithPatch() throws Exception {
        ...
        partialUpdatedTask.deadline(UPDATED_DEADLINE);
    ...
    void fullUpdateTaskWithPatch() throws Exception {
        ...
        partialUpdatedTask.description(UPDATED_DESCRIPTION).deadline(UPDATED_DEADLINE);
