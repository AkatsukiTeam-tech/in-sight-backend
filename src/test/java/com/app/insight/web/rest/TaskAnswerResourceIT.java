...
class TaskAnswerResourceIT {
    ...
    public static TaskAnswer createEntity(EntityManager em) {
        TaskAnswer taskAnswer = new TaskAnswer().description(DEFAULT_DESCRIPTION).score(DEFAULT_SCORE);
        return taskAnswer;
    }
    ...
    public static TaskAnswer createUpdatedEntity(EntityManager em) {
        TaskAnswer taskAnswer = new TaskAnswer().description(UPDATED_DESCRIPTION).score(UPDATED_SCORE);
        return taskAnswer;
    }
    ...
    void createTaskAnswer() throws Exception {
        ...
        assertThat(testTaskAnswer.getDescription()).isEqualTo(DEFAULT_DESCRIPTION);
        assertThat(testTaskAnswer.getScore()).isEqualTo(DEFAULT_SCORE);
    }
    ...
    @Test
    @Transactional
    void putExistingTaskAnswer() throws Exception {
        // Initialize the database
        taskAnswerRepository.saveAndFlush(taskAnswer);
        ...
        updatedTaskAnswer.description(UPDATED_DESCRIPTION).score(UPDATED_SCORE);
        ...
        TaskAnswer testTaskAnswer = taskAnswerList.get(taskAnswerList.size() - 1);
        assertThat(testTaskAnswer.getDescription()).isEqualTo(UPDATED_DESCRIPTION);
        assertThat(testTaskAnswer.getScore()).isEqualTo(UPDATED_SCORE);
    }
    ...
    void partialUpdateTaskAnswerWithPatch() throws Exception {
        ...
        partialUpdatedTaskAnswer.description(UPDATED_DESCRIPTION).score(UPDATED_SCORE);
