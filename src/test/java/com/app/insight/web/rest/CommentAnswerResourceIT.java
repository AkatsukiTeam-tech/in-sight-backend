...
class CommentAnswerResourceIT {
    ...
    public static CommentAnswer createEntity(EntityManager em) {
        CommentAnswer commentAnswer = new CommentAnswer().text(DEFAULT_TEXT).dateTime(DEFAULT_DATE_TIME);
    ...
    public static CommentAnswer createUpdatedEntity(EntityManager em) {
        CommentAnswer commentAnswer = new CommentAnswer().text(UPDATED_TEXT).dateTime(UPDATED_DATE_TIME);
        return commentAnswer;
    }
    ...
    void createCommentAnswer() throws Exception {
        ...
        assertThat(testCommentAnswer.getDateTime()).isEqualTo(DEFAULT_DATE_TIME);
    }
    ...
    @Test
    @Transactional
    void putExistingCommentAnswer() throws Exception {
        // Initialize the database
        commentAnswerRepository.saveAndFlush(commentAnswer);
        ...
        updatedCommentAnswer.text(UPDATED_TEXT).dateTime(UPDATED_DATE_TIME);
        ...
        assertThat(testCommentAnswer.getDateTime()).isEqualTo(UPDATED_DATE_TIME);
    }
    ...
    void partialUpdateCommentAnswerWithPatch() throws Exception {
        ...
        partialUpdatedCommentAnswer.text(UPDATED_TEXT).dateTime(UPDATED_DATE_TIME);
