...
import com.app.insight.repository.ScheduleRepository;
import com.app.insight.service.dto.ScheduleDTO;
import com.app.insight.service.mapper.ScheduleMapper;
...
class ScheduleResourceIT {
    ...
    public static Schedule createEntity(EntityManager em) {
        Schedule schedule = new Schedule().dateTime(DEFAULT_DATE_TIME);
        return schedule;
    }
    ...
    public static Schedule createUpdatedEntity(EntityManager em) {
        Schedule schedule = new Schedule().dateTime(UPDATED_DATE_TIME);
        return schedule;
    }
    ...
    void putExistingSchedule() throws Exception {
        ...
        updatedSchedule.dateTime(UPDATED_DATE_TIME);
    ...
    void partialUpdateScheduleWithPatch() throws Exception {
        ...
        partialUpdatedSchedule.dateTime(UPDATED_DATE_TIME);
