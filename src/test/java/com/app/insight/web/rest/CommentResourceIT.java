...
import com.app.insight.repository.CommentRepository;
import com.app.insight.service.dto.CommentDTO;
import com.app.insight.service.mapper.CommentMapper;
...
class CommentResourceIT {
    ...
    private static final CommentTypeEnum DEFAULT_TYPE = CommentTypeEnum.Post;
    private static final CommentTypeEnum UPDATED_TYPE = CommentTypeEnum.University;
    ...
    public static Comment createEntity(EntityManager em) {
        Comment comment = new Comment().text(DEFAULT_TEXT).type(DEFAULT_TYPE).dateTime(DEFAULT_DATE_TIME);
        return comment;
    }
    ...
    public static Comment createUpdatedEntity(EntityManager em) {
        Comment comment = new Comment().text(UPDATED_TEXT).type(UPDATED_TYPE).dateTime(UPDATED_DATE_TIME);
        return comment;
    }
    ...
    void putExistingComment() throws Exception {
        ...
        updatedComment.text(UPDATED_TEXT).type(UPDATED_TYPE).dateTime(UPDATED_DATE_TIME);
    ...
    void partialUpdateCommentWithPatch() throws Exception {
        ...
        partialUpdatedComment.text(UPDATED_TEXT).dateTime(UPDATED_DATE_TIME);
    ...
    void fullUpdateCommentWithPatch() throws Exception {
        ...
        partialUpdatedComment.text(UPDATED_TEXT).type(UPDATED_TYPE).dateTime(UPDATED_DATE_TIME);
