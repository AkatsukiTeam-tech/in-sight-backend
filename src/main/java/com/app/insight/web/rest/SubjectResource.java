...
import com.app.insight.service.SubjectService;
...
/**
 * REST controller for managing {@link com.app.insight.domain.Subject}.
 */
@RestController
@RequestMapping("/api")
public class SubjectResource {
     ...
     */
    @GetMapping("/subjects")
    public List<SubjectDTO> getAllSubjects(@RequestParam(required = false, defaultValue = "false") boolean eagerload) {
