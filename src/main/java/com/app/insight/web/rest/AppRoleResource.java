...
import com.app.insight.service.AppRoleService;
...
public class AppRoleResource {
    ...
    public ResponseEntity<AppRoleDTO> createAppRole(@RequestBody AppRoleDTO appRoleDTO) throws URISyntaxException {
    ...
    public ResponseEntity<AppRoleDTO> updateAppRole(
        ...
        @RequestBody AppRoleDTO appRoleDTO
    ...
    public List<AppRoleDTO> getAllAppRoles() {
        log.debug("REST request to get all AppRoles");
