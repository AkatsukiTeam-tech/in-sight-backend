...
/**
 * REST controller for managing {@link com.app.insight.domain.University}.
 */
@RestController
...
public class UniversityResource {
    ...
    public List<UniversityDTO> getAllUniversities(@RequestParam(required = false, defaultValue = "false") boolean eagerload) {
