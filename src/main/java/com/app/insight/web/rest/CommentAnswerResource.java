...
import com.app.insight.service.CommentAnswerService;
...
/**
 * REST controller for managing {@link com.app.insight.domain.CommentAnswer}.
 */
@RestController
...
public class CommentAnswerResource {
    ...
    public ResponseEntity<CommentAnswerDTO> updateCommentAnswer(
        ...
        CommentAnswerDTO result = commentAnswerService.update(commentAnswerDTO);
        return ResponseEntity
            .ok()
    ...
    public List<CommentAnswerDTO> getAllCommentAnswers() {
        log.debug("REST request to get all CommentAnswers");
        return commentAnswerService.findAll();
    }
